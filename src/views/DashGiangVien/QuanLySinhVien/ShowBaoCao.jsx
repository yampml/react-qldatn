...
class ShowBaoCao extends Component {
    ...
    render() {
        ...
        return (
            <GridContainer>
                <Grid>
                    <NavLink to="/giangvien/quanlysinhvien/1">{this.state.tenSV}</NavLink> > <NavLink to="/giangvien/quanlysinhvien/1/baocao">Duyệt báo cáo</NavLink> > Báo cáo { this.props.match.params.idbaocao }
                </Grid>
                <Card>
                        ...
                        <form className={ classes.container } noValidate autoComplete="off">
                            ...
                            <GridContainer>
                                <GridItem xs={ 12 } sm={ 12 } md={ 4 }>
                                    ...
                                    <Link style={ { margin: 8 } } to="/giangvien/quanlysinhvien/1/baocao/1"><Icon>attach_file</Icon> File 1</Link><br />
                                    <Link style={ { margin: 8 } } to="/giangvien/quanlysinhvien/1/baocao/1"><Icon>attach_file</Icon> File 2</Link><br />
                                    <Link style={ { margin: 8 } } to="/giangvien/quanlysinhvien/1/baocao/1"><Icon>attach_file</Icon> File 3</Link>
                                </GridItem>
                            </GridContainer>
