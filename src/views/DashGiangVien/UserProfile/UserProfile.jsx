...
class UserProfile extends Component {
  constructor(props) {
    ...
    this.state = {
      id: "123456789",
      tenTaiKhoan: "thaygiaoba",
      email: "thayhieutruong@baroi.beo",
        ...
        <GridContainer>
                ...
                <GridContainer>
                  ...
                  <GridItem xs={ 12 } sm={ 12 } md={ 4 }>
                    <TextField
                      ...
                      onChange={ this.handleChange('hocVi') }
                      margin="normal"
                      disabled
                      InputProps={ {
                        disableUnderline: !this.state.isEditing,
          ...
          <GridItem xs={ 12 } sm={ 12 } md={ 4 }>
            <Card profile>
              ...
              <CardBody profile>
                <h6 className={ classes.cardCategory }>{this.state.hocVi}</h6>
                <h4 className={ classes.cardTitle }>{this.state.ho} {this.state.ten}</h4>
                <p className={ classes.description }>
                    {this.state.gioiThieu}
                </p>
